...
('Loki', 'Grafana Loki is a horizontally scalable, highly available log aggregation system designed to store and query logs efficiently.', 'Log aggregation system for Kubernetes', 'MONITORING_AND_LOGGING', 'https://raw.githubusercontent.com/grafana/loki/main/docs/sources/logo_and_name.png', 'https://raw.githubusercontent.com/grafana/loki/main/docs/sources/logo_and_name.png', 1, 2, 2, 4, 10, 20, 80.0, 80.0, 1, 3, false, 3100, false, NULL, NULL, NULL, false, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(10, 'MONITORING_AND_LOGGING', 'loki', '17.1.6', 'https://grafana-community.github.io/helm-charts', 'https://artifacthub.io/packages/helm/grafana-community/loki/values.yaml', true, 'grafana-community', true, 'Grafana Community', 'grafana/loki');
