...
('Elasticsearch', 'Elasticsearch is a distributed, RESTful search and analytics engine capable of solving a growing number of use cases.', 'Distributed search and analytics engine', 'Databases & Storage', 'https://djeqr6to3dedg.cloudfront.net/repo-logos/library/elasticsearch/live/logo-1720462300603.png', 'https://djeqr6to3dedg.cloudfront.net/repo-logos/library/elasticsearch/live/logo-1720462300603.png', 2, 4, 2, 8, 2, 4, 80.0, 80.0, 1, 5, true, 9200, true, 'elasticsearch.example.com', '/', 'nginx', true, 'elasticsearch-tls', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
