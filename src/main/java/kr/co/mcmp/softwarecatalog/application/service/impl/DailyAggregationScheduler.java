        ...
        for (Long deploymentId : deploymentIds) {
            try {
                ...
                DailyMetricsSummary summary = DailyMetricsSummary.builder()
                        ...
                        .avgNetworkInBytes(proj.getAvgNetworkInBytes())
                        .maxNetworkInBytes(proj.getMaxNetworkInBytes())
                        .avgNetworkOutBytes(proj.getAvgNetworkOutBytes())
                        .maxNetworkOutBytes(proj.getMaxNetworkOutBytes())
