...
public interface ArtifactHubIntegrationService {
    ...
    /**
     * ArtifactHub에서 Helm Chart 상세 조회합니다.
     *
     * @return 버전 목록
     */
    ArtifactHubPackage.Package getPackageDetailInfo(String packageKind, String repository, String packagename, String version);
}
